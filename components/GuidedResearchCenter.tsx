...
import ProjectResetZone from "./ProjectResetZone";
...
const navGroups: Array<{ label: string; items: Array<{ id: NavId; icon: string; label: string; public: boolean }> }> = [
  { label: "開始", items: [{ id: "overview", icon: "grid", label: "研究總覽", public: true }, { id: "quick-start", icon: "plus", label: "智慧建立專案", public: true }] },
